...
public class TestAnalizadores extends SetParaTestearAnalizadores {
	...
	private List<Carga> resultadoDeAnalisis(String texto) {
		contenedor = new ContenedorDeStrings(new MockArchivo(texto), new CSV(","));
	...
	@Test
	public void puedoAnalizarUnContenedorYQueMeGenereDosCargas() {
	...
	@Test
	public void dosTokensDeEmpresasInexistentesDanDosAltas() {
	...
	@Test
	public void dosTokensDeEmpresasExistentesDanDosModificaciones() {
